...
<title>Insert title here</title>
			...
			$.ajax({
		        ...
		        success:function(res){
		        	...
		        	for(let i = 0; i < res.class.length; i++){
		        		...
		        		tr.innerHTML = "<td>"+res.class[i].friendId+"</td>"
		        		tr.innerHTML += "<td>"+res.class[i].friendName+"</td>"
		        		tr.innerHTML += "<td><button onclick=insertFriend("+i+")>친구추가</button></td>"
		        	}
		        },
		        error:function(){
		            alert("error")
		...
		function insertFriend(num){
			
			console.log(id.innerHTML)
			console.log(friend[num].friendId)
			console.log(friend[num].friendName)
					...
					<nav>
						<ul id=ul>
							...
							<%if(dto != null){ %>
								...
								<li><a href="#intro"><span class="scrolly">Friends Search</span></a></li>
							<%} else { %>
							<%} %>
						</ul>
					</nav>
						...
						<div class="inner">
							<table>
								...
								<tr>
									...
									<td><button onclick="searchUser()">검색</button></td>
								</tr>
							</table>
